...
/**
 * @author victo Fazer um programa para ler o nome de um aluno e as três notas
 ...
 *         final do aluno no ano. Dizer também se o aluno está aprovado (PASS)
 *         ou não (FAILED) e, em caso negativo, quantos pontos faltam para o
 *         aluno obter o mínimo para ser aprovado (que é 60% da nota). Você deve
