...
/**
 * @author victo Um Posto de combustíveis deseja determinar qual de seus
 ...
 *         forma: 1.Álcool 2.Gasolina 3.Diesel 4.Fim). Caso o usuário informe um
 *         código inválido (fora da faixa de 1 a 4) deve ser solicitado um novo
 *         código (até que seja válido). O programa será encerrado quando o
 *         código informado for o número 4. Deve ser escrito a mensagem: "MUITO
